...
/**
 * 类描述:〈玛瑙湾趸交还款用例，走京东 57〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class MnwPremiumJdTC extends Premium5213TestCase {

  PayGroupPlatformEnum payGroupPlatformEnum = PayGroupPlatformEnum.JD_JN_XY;
  ...
  public void premium() {
    ...
    //还款
    HttpResponse httpResponse = super.repayment.jdPremiumJN(scheduleId, super.routerEnvVersion);
    //校验是否请求成功
