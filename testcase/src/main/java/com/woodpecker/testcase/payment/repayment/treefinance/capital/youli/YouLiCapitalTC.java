 ...
 * @since: 1.0
 */
public class YouLiCapitalTC extends CapitalRepaymentTestCase {

  String payGroupCode = "33";//支付组code

  String payPlatformCode = "62";//支付通道code

  String channel = "62";//下游渠道号
   ...
   * 用例说明：当期还款，走体内 --> 有利网
   */
  @Test(description = "支付通道：有利网", timeOut = 180000)
  public void youLiRepayment() {
    ...
    //还款
    HttpResponse httpResponse = super.repayment.youLiRepayment(scheduleId, super.routerEnvVersion);
    //校验是否请求成功
