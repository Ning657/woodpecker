package com.woodpecker.testcase.payment.repayment.treefinance.premium4551.bohai;
...
/**
 * 类描述:〈渤海信托趸交还款用例，走通联协议支付 60〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class BoHaiPremiumTongLianTC extends PremiumRepaymentTestCase {
   ...
   * 资金渠道
   */
  final PlatformIdEnum platformIdEnum = PlatformIdEnum.BH;
