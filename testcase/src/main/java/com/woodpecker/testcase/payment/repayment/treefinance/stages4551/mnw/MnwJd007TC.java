package com.woodpecker.testcase.payment.repayment.treefinance.stages4551.mnw;
...
/**
 * 类描述:〈玛瑙湾走京东两方代扣007(JDAGREEMENTPAY_4551)，通道42〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class MnwJd007TC extends Stages4551TestCase {
  ...
  protected String payChannel = "MNWPAY";
   ...
   * 资金渠道，指定为玛瑙湾渠道，不可改
   */
  private final PlatformIdEnum platformIdEnum = PlatformIdEnum.MNW;
  ...
  public void collectionWithhold() {
    ...
    //注意点：需要看下银行限额，如果超过限额，则第一期还款原本是走「玛瑙湾资金账户」的，会变成走「京东两方代扣（007）42」
    //获取出bankId
