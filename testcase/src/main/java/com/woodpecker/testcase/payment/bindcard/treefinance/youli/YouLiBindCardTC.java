package com.woodpecker.testcase.payment.bindcard.treefinance.youli;
 ...
 * @since: 1.0
 */
public class YouLiBindCardTC extends BindCardTestCase {

  protected String deductPlatform = "YOOLI_PAY";

  protected String channel = "62";
