package com.woodpecker.testcase.payment.repayment.treefinance.capital.guangda;
 ...
 * @since: 1.0
 */
public class GuangDaCapitalTC extends CapitalRepaymentTestCase {

  PayGroupPlatformEnum payGroupPlatformEnum = PayGroupPlatformEnum.GUANGDA;
  ...
  PlatformIdEnum platformIdEnum = PlatformIdEnum.GUANGDA;
   ...
   * 用例说明：当期还款，走体内 --> 渤海
   */
  @Test(description = "支付通道：渤海", timeOut = 180000)
  public void boHaiRepayment() {
    ...
    //还款
    HttpResponse httpResponse = super.repayment.boHaiRepayment(scheduleId, super.routerEnvVersion);
    //校验是否请求成功
