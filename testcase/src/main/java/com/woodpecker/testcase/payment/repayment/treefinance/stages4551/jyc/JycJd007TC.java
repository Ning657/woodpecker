package com.woodpecker.testcase.payment.repayment.treefinance.stages4551.jyc;
...
/**
 * 类描述:〈聚有财走京东两方代扣007(JDAGREEMENTPAY_4551)，通道42〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class JycJd007TC extends Stages4551TestCase {
  ...
  PlatformIdEnum platformIdEnum = PlatformIdEnum.JYC;
