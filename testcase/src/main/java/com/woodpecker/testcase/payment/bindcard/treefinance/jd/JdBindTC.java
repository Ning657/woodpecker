 ...
 * @since: 1.0
 */
public class JdBindTC extends BindTestCase {

  BindChannelEnum bindChannel = BindChannelEnum.JDAGREEMENTPAY;
  ...
  @Test(description = "京东绑卡", timeOut = 60000)
  public void jdBindCard() {
