package com.woodpecker.testcase.payment.bindcard.treefinance.capital.youli;
 ...
 * @since: 1.0
 */
public class YouLiBindTC extends BindTestCase {

  BindChannelEnum bindChannel = BindChannelEnum.YOOLI_PAY;
  ...
  @Test(description = "有利网鉴权", timeOut = 60000)
  public void auth() {
