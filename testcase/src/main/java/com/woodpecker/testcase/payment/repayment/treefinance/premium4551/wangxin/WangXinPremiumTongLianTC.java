...
/**
 * 类描述:〈网信趸交还款用例，走通联协议支付 60〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class WangXinPremiumTongLianTC extends PremiumRepaymentTestCase {
   ...
   * 资金渠道
   */
  final PlatformIdEnum platformIdEnum = PlatformIdEnum.WX;
  ...
  public void premium() {
    ...
    //注意：网信是不需要大树去扣趸交的，但是如果网信扣趸交失败，则需要大树自己去扣趸交
    //databuild生成还款订单的时候，是自动设置网信的趸交计划「已还」的，需要手动改为「未还」
    //把趸交计划改为「未还」
