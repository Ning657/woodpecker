package com.woodpecker.testcase.payment.repayment.treefinance.premium4551.mnw;
...
/**
 * 类描述:〈玛瑙湾趸交还款用例，走通联协议支付 60〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class MnwPremiumTongLianTC extends PremiumRepaymentTestCase {
   ...
   * 资金渠道
   */
  final PlatformIdEnum platformIdEnum = PlatformIdEnum.MNW;
