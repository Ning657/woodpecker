package com.woodpecker.testcase.payment.repayment.treefinance.premium4551.xizang;
...
/**
 * 类描述:〈西藏信托趸交还款用例，走通联协议支付 60〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class XiZangPremiumTongLianTC extends PremiumRepaymentTestCase {
   ...
   * 资金渠道
   */
  final PlatformIdEnum platformIdEnum = PlatformIdEnum.ZX;
