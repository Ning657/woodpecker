package com.woodpecker.testcase.payment.repayment.treefinance.stages4551.xingrui;
...
/**
 * 类描述:〈兴睿信托走京东两方代扣007(JDAGREEMENTPAY_4551)，通道42〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
public class XingRuiJd007TC extends Stages4551TestCase {
   ...
   * 资金渠道，指定为兴睿信托渠道，不可改
   */
  private final PlatformIdEnum platformIdEnum = PlatformIdEnum.XRXT;
  ...
  public void collectionWithhold() {
    ...
    //兴睿信托没有体内还款，全部都走大树4551，需要不需要先将第一期置为已结清，再去还第二期，直接还第一期即可。
    //将第一期还款计划置为已结清
