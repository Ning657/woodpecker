 ...
 * @since: 1.0
 */
public class SsjCapitalTC extends RepaymentTestCase {

  protected String payChannel = "SSJPAY";
  ...
  public void collectionWithhold() {
    ...
    super.bindCard(loanOrderId, "50", "SSJPAY");
    //读取还款计划表的前面二期的还款计划
    //因为第一期是正常还款，走的是「随手记资金账户」，也就是「随手记 50」
    //第一期
    ...
    //注意点：需要看下银行限额，如果超过限额，则第一期还款原本是走「随手记资金账户」的，会变成走「京东两方代扣（007）42」
    //获取出bankId
