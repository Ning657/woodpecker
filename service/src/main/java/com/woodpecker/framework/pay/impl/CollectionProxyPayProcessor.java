 ...
 */
@AutoProxy
@PayService(repayType = RepayTypeEnum.COLLECTION_PROXY, desc = "催收代扣")
public class CollectionProxyPayProcessor extends AbstractPayProcessor {
  ...
  protected HttpResponse doPay(long id, BigDecimal amount) {
    ...
    logger.debug("还款方式：催收代扣;[{}]接口参数为[{}]", url, data);
    //发送还款请求
