 ...
 * @since: 1.0
 */
@BindService(bindCardEnum = BindCardEnum.BOHAITRUST)
public class BoHaiBindProcessor extends AbstractBindProcessor {
  ...
  private String deductPlatform = BindCardEnum.BOHAITRUST.getPayPlatformName();
  ...
  protected int doBind(BindCardDto bindCardDto) {
    //强制设置为绑BOHAITRUST，因为这个类就是绑BOHAITRUST的
