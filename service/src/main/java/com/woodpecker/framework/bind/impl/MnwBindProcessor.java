 ...
 * @since: 1.0
 */
@BindService(bindCardEnum = BindCardEnum.MNWPAY)
public class MnwBindProcessor extends AbstractBindProcessor {
  ...
  private String deductPlatform = BindCardEnum.MNWPAY.getPayPlatformName();
