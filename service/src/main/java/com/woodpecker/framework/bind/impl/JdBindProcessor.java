...
/**
 * 类描述:〈绑卡通道：JDAGREEMENTPAY〉
 *
 * @author: jinjianxu
 * @since: 1.0
 */
@BindService(bindCardEnum = BindCardEnum.JDAGREEMENTPAY)
public class JdBindProcessor extends AbstractBindProcessor {
  ...
  private String deductPlatform = BindCardEnum.JDAGREEMENTPAY.getPayPlatformName();


  /**
   * 方法功能描述: JDAGREEMENTPAY绑卡
   *
  ...
  protected int doBind(BindCardDto bindCardDto) {
    //强制设置为绑JDAGREEMENTPAY，因为这个类就是绑JDAGREEMENTPAY的
